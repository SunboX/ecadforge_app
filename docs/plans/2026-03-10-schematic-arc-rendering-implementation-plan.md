...
Add a fixture-backed test that loads `tests/fixtures/altium/Skylace-Nova.SchDoc` and asserts one inductor owner exposes three normalized arc primitives with the expected centers, radius, and start/end angles.
