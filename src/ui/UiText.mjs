const FALLBACK_MESSAGES = {
    ...
    'sidebar.layerGroupAdhesive': 'Adhesive',
    'sidebar.layerGroupCopper': 'Copper',
    'sidebar.layerGroupDrawings': 'Drawings',
