 ...
 */
export class PcbBoardClickGuard {
    ...
    /**
     * @param {(target: unknown) => { getAttribute?: (name: string) => string | null } | null} resolveSvgNode Board SVG resolver.
     */
    ...
    shouldSuppressClick(event) {
        ...
        return (
            ...
            PcbBoardClickGuard.#readViewBox(svgNode) !== mouseDownState.viewBox
        )
    }
    ...
    /**
     * Records a primary-button board mouse-down as a possible click start.
    ...
    #handleMouseDownEvent(event) {
        ...
        this.#mouseDownState = {
            ...
            viewBox: PcbBoardClickGuard.#readViewBox(svgNode)
        }
    }
