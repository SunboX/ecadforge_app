...
test('ViewerSidebarRenderer renders the board overview in the info panel', () => {
    ...
    assert.match(html, /data-pcb-assembly-export-format="step"/)
    assert.match(html, /data-pcb-assembly-export-format="wrl"/)
    assert.match(html, /data-pcb-assembly-export-format="glb"/)
    assert.match(html, /Export STEP assembly/)
    assert.match(html, /Export WRL assembly/)
    assert.match(html, /Export GLB assembly/)
